...
import { assetService, assetTypeService } from '../asset-container.js';
import { AssetWebController } from './asset-controller.js';

const router = Router();
const assetWebController = new AssetWebController( assetService, assetTypeService, employeeService );
